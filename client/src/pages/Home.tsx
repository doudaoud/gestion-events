    ...
    <React.Fragment>
      ...
      <section id="features" className="features-section">
        <div className="features-header">
          ...
          <p className="section-subtitle">
            Our tools are built for the intensity of high-stakes event coordination.
          </p>
        </div>
        ...
        <div className="features-grid">
          ...
          <div className="feature-card feature-card--analytics">
            <div className="feature-card-icon">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="rgb(96,99,238)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <p className="feature-card-desc">
              Monitor ticket sales, attendee demographics, and engagement metrics live as they happen.
            </p>
          ...
          <div className="features-right">
            ...
            <div className="feature-card feature-card--scheduling">
              <div className="feature-card-top">
                <div className="feature-card-icon">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="rgb(96,99,238)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <p className="feature-card-desc">
                Advanced agenda tools that make multi-track management really simple.
              </p>
            </div>
            ...
            <div className="features-small-grid">
              <div className="feature-card feature-card--small">
                ...
                <p className="feature-card-desc">Granular role-based team permissions.</p>
              </div>
              ...
              <div className="feature-card feature-card--small">
                ...
                <p className="feature-card-desc">Dedicated live event manager support.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="contact" className="cta-section">
        <div className="cta-card">
          ...
          <p className="cta-subtitle">
            Join 10,000+ organizers who trust Gestion Events for their most critical logistics.
          </p>
          <div className="cta-buttons">
            <button className="cta-btn cta-btn--primary">Get Started Now</button>
        ...
        <div className="footer-content">
          ...
          <div className="footer-brand">
            ...
            <p className="footer-brand-desc">
              Leading the industry in premium event management software with sophisticated design
              and powerful logistics.
            </p>
